# TODO - ai-resume-builder

Repository: https://github.com/RanaPriyansh/ai-resume-builder.git
Canonical local path: /root/git-repos/app-factory/apps/ai-resume-builder
...
3. Run the local setup path for ai-resume-builder and write exact commands back into README if they are missing or stale.
