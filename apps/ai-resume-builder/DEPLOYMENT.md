...
## iOS App
1. Open Xcode project in iOS/ResumeBuilder/
2. Set bundle identifier: com.appfactory.resumebuilder
...
- Create product: "AI Resume Builder" ($9/mo)
