# Deploying Teacher Assistant

## Backend (One-time)
1. Create Stripe product and price ($15/month)
...
## iOS App
1. Open Xcode project in iOS/TeacherAssistant/
2. Set bundle identifier: com.appfactory.teacherassistant
...
- Create product: "Teacher Assistant" ($15/mo)
