...
Repository: https://github.com/RanaPriyansh/finance-coach.git
Canonical local path: /root/git-repos/app-factory/apps/finance-coach
...
3. Run the local setup path for finance-coach and write exact commands back into README if they are missing or stale.
