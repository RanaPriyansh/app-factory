# Deploying AI Finance Coach

## Backend (One-time)
1. Create Stripe product and price ($12/month)
...
## iOS App
1. Open Xcode project in iOS/FinanceCoach/
2. Set bundle identifier: com.appfactory.financecoach
...
- Create product: "AI Finance Coach" ($12/mo)
